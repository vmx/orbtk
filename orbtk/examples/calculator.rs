...
fn generate_digit_button(
    ...
    let button = Button::new()
        ...
        .on_click(move |states, _| -> bool {
            println!("vmx: digit button clicked: {:?}", sight);
                ...
                Grid::new()
                    ...
                    .child(
                        Container::new()
                            ...
                            .child(
                                Grid::new()
                                    .columns("350, 4, 350, 4, 350, 3, 350")
                                    .rows("350, 4, 350, 4, 350, 4, 350, 4, 350")
                                    // row 0
